...
python ~/.codex/skills/drawio-skill/scripts/repair_png.py output.drawio.png

# 验证 drawio 文件结构
python ~/.codex/skills/drawio-skill/scripts/validate.py input.drawio

# 搜索官方形状
python ~/.codex/skills/drawio-skill/scripts/shapesearch.py "flowchart decision" --limit 5
```
