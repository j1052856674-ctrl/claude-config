...
| 输入 | 必须 | 说明 |
|------|:--:|------|
| 原始评审报告路径 | ✅ | 从 `.claude/memory/reviews/` 读取行动项和验证方式 |
...
```
条件 1: 当前评审对象存在历史评审报告（.claude/memory/reviews/review-*-{target}.md）
...
```
"验证这个修复: 原始评审在 .claude/memory/reviews/review-20260612-xxx.md, 
